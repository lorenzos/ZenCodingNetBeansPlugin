...
public final class ZenCodingWrapWithAbbreviation implements ActionListener {

	private final List<EditorCookie> context;

	public ZenCodingWrapWithAbbreviation(List<EditorCookie> context) {
	...
	public void actionPerformed(ActionEvent ev) {
		...
		for (EditorCookie editorCookie : this.context) {
			...
			try {
				...
				jsRunner.runAction(editor, "wrap_with_abbreviation");
